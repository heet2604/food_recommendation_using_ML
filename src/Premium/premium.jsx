...
import { Leaf, Bot, MessageSquare, Check, Crown, ArrowRight, X ,Home } from "lucide-react";
        ...
        <div className="container mx-auto py-4 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <motion.button
              ...
              className="absolute top-6 right-6 bg-green-700 hover:bg-green-600 text-white py-2 px-4 rounded-md flex items-center gap-2"
