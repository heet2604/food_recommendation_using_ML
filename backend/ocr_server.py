...
#     dessert_categories = ['Dessert', 'Desserts', 'Sweet', 'Sweets', 'Mithai']
#     snack_categories = ['Snack', 'Snacks', 'Chaat']
    
#     # Create a new column for category group
...
#     """Filter foods that are suitable for diabetics and minimally processed."""
...
#     # Apply additional health filters for diabetics
...
#     # Filter diabetes-friendly foods
